...
function ConfirmationModal({ categoryName, isFlashcardOpen, dispatch }) {
    ...
    return (
        <div className="fixed min-h-screen min-w-full top-0 flex items-end justify-center md:items-center z-10 bg-black bg-opacity-50">
            <div ref={modalRef} className="transform translate-y-24 md:-translate-y-24 bg-gray-900 px-3 py-2 rounded-tl-2xl rounded-tr-2xl md:rounded-bl-2xl md:rounded-br-2xl flex flex-col gap-4 md:w-96 max-h-72 h-44 w-full shadow-2xl">
                ...
                <section className="flex gap-2 justify-end my-auto">
                    ...
                    <Button
                        ...
                        className="bg-green-900 text-white rounded-lg font-bold py-2 px-2 hover:bg-green-800 shadow w-32 md:w-32"
                        text="No"
                    />
                </section>
            </div>
